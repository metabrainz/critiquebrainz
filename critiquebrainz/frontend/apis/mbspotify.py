...
class MBSpotifyClient(object):
    ...
    def add_mapping(self, mbid, spotify_uri, user_id):
        ...
        requests.post(self.base_url + 'mapping/add', headers={'Content-Type': 'application/json'},
    ...
    def vote(self, mbid, user_id):
        ...
        requests.post(self.base_url + 'mapping/vote', headers={'Content-Type': 'application/json'},
