...
from critiquebrainz.frontend.external import musicbrainz, mbspotify, external_players
...
def entity(id):
    ...
    if len(release_group['release-list']) > 0:
        ...
        release = None
    external_mappings = external_players.get_url(id)
    ...
    return render_template('release_group/entity.html', id=id, release_group=release_group, reviews=reviews,
                           ...
                           soundcloud_url=soundcloud_url, bandcamp_id=bandcamp_id, limit=limit, offset=offset, count=count)
